...
namespace Laps.Authoring
{
    ...
    public class EclaireDroiteOverlayRenderer : MonoBehaviour
    {
        ...
        private void InitVideoPlayer()
        {
            ...
            _videoPlayer.url = System.IO.Path.Combine(Application.streamingAssetsPath, "eclaire_droite_overlay.mov");
        ...
        private void OnError(VideoPlayer vp, string message)
            => Debug.LogError($"[EclaireDroiteOverlayRenderer] Erreur vidéo : {message}");
