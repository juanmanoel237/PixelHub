...
{
    /// <summary>
    /// Gère le VideoPlayer pour la vidéo éclair gauche et expose la RenderTexture.
    /// Alimente EclaireGaucheOverlayCompositor pour envoyer l'éclair au mur LED.
    /// </summary>
    public class EclaireGaucheOverlayRenderer : MonoBehaviour
    {
        public static EclaireGaucheOverlayRenderer Instance { get; private set; }
        ...
        {
            EclaireGaucheOverlayCompositor.ClearFrame();
        ...
        private void OnReadbackComplete(AsyncGPUReadbackRequest request)
        {
            ...
            if (_frameCount % 60 == 0)
            {
                ...
                Debug.Log($"[EclaireGaucheOverlayRenderer] Frame {_frameCount}, Max Luma: {maxLuma}");
            }
            _frameCount++;

            EclaireGaucheOverlayCompositor.SetFrame(_pixelBuffer, _pixelWidth, _pixelHeight);
        }
        ...
        private void InitVideoPlayer()
        {
            ...
            Debug.Log("[EclaireGaucheOverlayRenderer] Préparation de la vidéo éclair gauche…");
        }
        ...
        private void OnPrepared(VideoPlayer vp)
        {
            ...
            if (!_paused) vp.Play();
            _videoReady = true;
            Debug.Log($"[EclaireGaucheOverlayRenderer] Vidéo prête ({w}×{h}), lecture en boucle.");
        }
