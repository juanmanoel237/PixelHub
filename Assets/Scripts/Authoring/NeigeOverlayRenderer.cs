...
{
    /// <summary>
    /// Gère le VideoPlayer pour la vidéo de neige overlay et expose la RenderTexture.
    /// Alimente NeigeOverlayCompositor pour envoyer la neige au mur LED.
    /// </summary>
    public class NeigeOverlayRenderer : MonoBehaviour
    {
        public static NeigeOverlayRenderer Instance { get; private set; }
        ...
        private void OnDisable()
        {
            ...
            NeigeOverlayCompositor.ClearFrame();
        ...
        private void OnReadbackComplete(AsyncGPUReadbackRequest request)
        {
            ...
            if (_frameCount % 60 == 0)
            {
                ...
                Debug.Log($"[NeigeOverlayRenderer] Frame {_frameCount}, Max Luma: {maxLuma}");
            }
            _frameCount++;

            NeigeOverlayCompositor.SetFrame(_pixelBuffer, _pixelWidth, _pixelHeight);
        }
        ...
        private void InitVideoPlayer()
        {
            ...
            _videoPlayer.url = ResolveVideoUrl("neige_overlay");
            ...
            Debug.Log("[NeigeOverlayRenderer] Préparation de la vidéo neige…");
        }
        ...
        private void OnPrepared(VideoPlayer vp)
        {
            ...
            if (!_paused)
                vp.Play();
            _videoReady = true;
            Debug.Log($"[NeigeOverlayRenderer] Vidéo neige prête ({w}×{h}), lecture en boucle.");
        }

        private void OnError(VideoPlayer vp, string message)
        {
            Debug.LogWarning(
                "[NeigeOverlayRenderer] Vidéo neige illisible. " +
                "Placez neige_overlay.webm (VP8+alpha) ou .mp4 (H.264) dans StreamingAssets. " +
                $"Détail : {message}");
        }
