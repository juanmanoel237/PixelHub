...
{
    /// <summary>
    /// Composite vidéo overlay (éclair droite) sur le buffer LED.
    /// Authoring alimente les pixels via EclaireDroiteOverlayRenderer ;
    /// Routing appelle CompositeOnto sans dépendre de Authoring.
    /// </summary>
    public static class EclaireDroiteOverlayCompositor
    {
